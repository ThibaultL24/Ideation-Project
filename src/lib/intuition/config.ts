...
export function getNetworkConfig(network = resolveNetwork()): IntuitionNetworkConfig {
  return CONFIG[network];
}

/** Canonical object atom for idea attestation triples (mainnet). */
...
/** @deprecated Use IDEA_PREDICATE_LABEL */
